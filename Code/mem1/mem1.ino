...
#define RM_IN3    5
#define RM_IN4    7
#define FWD       1 // go forward(2)
#define LFT       2 // go left(4)
#define RGT       3 // go right(6)
#define BWD       4// go backward(8)
#define STOP      5 // stop(0)
#define RPEAT     6 // repeat the stored sequence of movement from the temporary memory(automatically stores) (REPT)
#define DEL       7 // delete the stored sequence of movement from temporary memory(EQ)
#define PERST     8 // copy the sequence from temp. memory to the peramanent memory(EEPROM)
#define PLAYEPROM 9 // repeat the sequence stored in EEPROM(FASTFWD)
#define RESET     0 // Resets the Arduino Board(RED)
